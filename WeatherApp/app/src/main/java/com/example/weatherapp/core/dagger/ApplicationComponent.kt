...
@Singleton
@Component(modules = [LocationModule::class, ViewModelModule::class, StorageModule::class, DatabaseModule::class, DispatcherModule::class, DateTimeComponent::class, ApiComponent::class])
